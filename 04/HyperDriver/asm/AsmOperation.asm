...
AsmRestoreToVMXOFFState PROC PUBLIC
	...
	; VmxInitialize, e cioè RSP puntava ad istruzione successiva a call VmxInitialize in DriverEntry.
	; Dopo aver eseguito tali istruzioni, invece, su stack c'è lo spazio allocato all'inizio di 
