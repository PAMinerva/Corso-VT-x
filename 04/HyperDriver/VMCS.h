...
enum VMCS_FIELDS
{
    ...
    VM_EXIT_QUALIFICATION = VMCS_ENCODE_COMPONENT_FULL(information, natural, 0),
    IO_RCX = VMCS_ENCODE_COMPONENT_FULL(information, natural, 1),
    IO_RSI = VMCS_ENCODE_COMPONENT_FULL(information, natural, 2),
    IO_RDI = VMCS_ENCODE_COMPONENT_FULL(information, natural, 3),
    IO_RIP = VMCS_ENCODE_COMPONENT_FULL(information, natural, 4),
    GUEST_LINEAR_ADDRESS = VMCS_ENCODE_COMPONENT_FULL(information, natural, 5),

    // 64-bit Read only Register State Fields
    GUEST_PHYSICAL_ADDRESS = VMCS_ENCODE_COMPONENT_FULL_64(information, 0),

    // 32-bit Read only Register State Fields
    VM_INSTRUCTION_ERROR = VMCS_ENCODE_COMPONENT_FULL_32(information, 0),
    VM_EXIT_REASON = VMCS_ENCODE_COMPONENT_FULL_32(information, 1),
    VM_EXIT_INTERRUPTION_INFORMATION = VMCS_ENCODE_COMPONENT_FULL_32(information, 2),
    VM_EXIT_INTERRUPTION_ERROR_CODE = VMCS_ENCODE_COMPONENT_FULL_32(information, 3),
    IDT_VECTORING_INFORMATION_FIELD = VMCS_ENCODE_COMPONENT_FULL_32(information, 4),
    IDT_VECTORING_ERROR_CODE = VMCS_ENCODE_COMPONENT_FULL_32(information, 5),
    VM_EXIT_INSTRUCTION_LENGTH = VMCS_ENCODE_COMPONENT_FULL_32(information, 6),
    VM_EXIT_INSTRUCTION_INFORMATION = VMCS_ENCODE_COMPONENT_FULL_32(information, 7),
};
